...
try {
   ...
   /*  $mail->addAttachment('/var/tmp/file.tar.gz');         // Add attachments
    ...
    $mail->Body    = "Поступила заявка с сайта АДР " . " Тема:" . $theme . " Имя:" . $name . " Телефон:" . $phone . " Почта:" . $email;
    $mail->AltBody = "Поступила заявка с сайта АДР " . " Тема:" . $theme . " Имя:" . $name . " Телефон:" . $phone . " Почта:" . $email;
